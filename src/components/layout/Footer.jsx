    ...
    <footer className="bg-gradient-to-br from-[var(--blue-900)] to-[#060d3a] text-[#a0a6cc] font-sans relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-20 grid lg:grid-cols-[1.5fr_1fr_1.5fr_1fr] md:grid-cols-2 gap-x-12 gap-y-16">
        ...
        <div className="flex flex-col gap-6">
          <img src={logoImg} alt="Catalyst Education" className="h-11 w-auto object-contain self-start" />
          ...
          <div className="flex items-center gap-3 mt-3">
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center transition-colors">
            ...
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center transition-colors">
              <svg width={18} height={18} viewBox="0 0 24 24" fill="currentColor" className="text-white/80 hover:text-white"><path d="M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zm-8.84 14.5l-4.72-2.73L12 9l6.56 5.77-4.72 2.73a1.9 1.9 0 01-3.68 0z" /></svg>
            </a>
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-4">
            {['Home', 'About Us', 'Blog & Insights', 'Campus Gallery', 'Contact Support'].map((link, i) => (
              <li key={i}>
                <a href="#" className="flex items-center gap-2.5 hover:text-white transition-colors text-[14px]">
          ...
          <ul className="flex flex-col">
            {['Calicut', 'Vadakara', 'Kannur', 'Manjeri', 'Kottakkal', 'Perinthalmanna', 'Thrissur', 'Kochi', 'Edappal'].map((campus, i) => (
              <li key={i} className="border-b border-white/5 last:border-0 py-3.5 first:pt-0">
                <a href="#" className="flex items-center justify-between hover:text-white transition-colors group">
      ...
      <div className="bg-black/20 py-6 text-center text-[13px] text-[#a0a6cc] border-t border-white/5">
        © 2026 Catalyst Hub. All Rights Reserved. <span className="mx-3 text-white/10">|</span> Developed by TechBrein
      </div>
    </footer>
  );
}

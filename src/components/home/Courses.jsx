...
export default function Courses() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        variants={{
          ...
          visible: {
            opacity: 1,
            transition: {
              staggerChildren: 0.08, // Very fast stagger so they don't keep you waiting
              delayChildren: 0.05
            }
          }
        }}
        className="relative z-10 w-full max-w-[1224px] mx-auto pb-14 px-6 lg:px-10 course-carousel-container"
      ...
      >
        <div
          className="overflow-hidden pt-12 pb-20 px-4 -mx-4 -mt-8 cursor-grab active:cursor-grabbing"

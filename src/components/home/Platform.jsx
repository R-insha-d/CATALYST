...
export default function Platform() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0E1D6B] to-[#050814] py-20 lg:py-35 sm:py-24 text-center border-y border-[rgba(20,40,160,0.2)]">
      <CtaStripBackground />
